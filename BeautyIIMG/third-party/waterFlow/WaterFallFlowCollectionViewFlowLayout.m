...
-(CGFloat)getHeaderSizeOfOneSection:(SectionItem*)sectionItem
{
    ...
    CGFloat headerHeight = sectionItem.headerSize.height*(headerWidth/sectionItem.headerSize.width);
    return headerHeight;
}
...
-(CGFloat)getFooterSizeOfOneSection:(SectionItem*)sectionItem
{
    ...
    CGFloat footerHeight = sectionItem.footerSize.height*(footerWidth/sectionItem.footerSize.width);
    return footerHeight;
}
...
-(instancetype)init
{
    ...
    self.headerType = SupplementType_ALL;
    self.footerType = SupplementType_ALL;
